...
// This file contains the schema definitions for the enhanced SkillSwap backend

export const migration = sql`
-- Add new columns to users table
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "credit_balance" integer DEFAULT 0 NOT NULL;
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "subscription_status" varchar DEFAULT 'basic' NOT NULL;
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "subscription_expires_at" timestamp;
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "total_sessions_completed" integer DEFAULT 0 NOT NULL;
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "total_sessions_taught" integer DEFAULT 0 NOT NULL;
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "skill_points" integer DEFAULT 0 NOT NULL;
